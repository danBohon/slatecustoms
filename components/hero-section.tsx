  ...
  return (
    <section className="flex min-h-[60vh] flex-col items-center justify-center px-6 py-20 text-center">
      <div className="flex w-full max-w-3xl flex-col items-center gap-8 sm:gap-10">
        ...
        <p className="font-sans text-sm font-medium text-text-secondary sm:text-base">
        ...
        <div className="mt-2 flex flex-col items-center gap-4 sm:gap-5">
          ...
          <p className="font-sans text-sm text-text-secondary sm:text-base">
            ...
            <a
              href="#contact"
              className="font-medium text-text-primary underline underline-offset-4 transition-colors hover:text-accent-hover"
            >
